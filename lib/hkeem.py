...
# =========================
os.environ["GOOGLE_API_KEY"] = os.getenv("GOOGLE_API_KEY", "AIzaSyArrvAB6j24pNerQe0LXwZKwoHGKABHCOw")
...
async def transcribe_report(file: UploadFile = File(...)):
    # تحقق من نوع الملف
    ...
    try:
        ...
        # FastAPI هيحوّل الـ Pydantic object إلى JSON لوحده
        return report
