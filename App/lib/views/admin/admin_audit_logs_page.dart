...
class _AdminAuditLogsPageState extends ConsumerState<AdminAuditLogsPage> {
  ...
  void _showFilterSheet(
    ...
    const commonActions = [
      // Auth
      'LOGIN', 'LOGOUT', 'TOKEN_REFRESH', 'PASSWORD_CHANGED',
      // Account
      'ACTIVATE', 'DEACTIVATE',
      ...
      // Visits
      'VISIT_STARTED', 'VISIT_UPDATED', 'VISIT_COMPLETED',
      // Reports
      'REPORT_CREATED', 'REPORT_UPDATED',
      'REPORT_APPROVED', 'REPORT_FINALIZED', 'REPORT_DELETED',
      // Media
      'IMAGE_UPLOADED', 'IMAGE_REVIEWED', 'LAB_UPLOADED',
    ];
  ...
  Color _actionColor(String action) {
    switch (action.toUpperCase()) {
      ...
      case 'USER_UPDATED':
      case 'USER_DELETED':
        return action.endsWith('DELETED') ? _T.urgent : _T.indigo;
      // Patients
