                ...
                children: [
                  ...
                  Expanded(
                    child: _OverviewCard(
                      ...
                      value:
                          '${arNumber(revenueToday.round(), localeCode)} ${loc.currencyEgp}',
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF0B3D6B).withValues(alpha: 0.06),
            blurRadius: 10,
                ...
                SizedBox(
                  ...
                  child: FilledButton.icon(
                    ...
                    style: FilledButton.styleFrom(
                      ...
                      disabledBackgroundColor: DoctorTheme.navy.withValues(
                        alpha: 0.35,
                      ),
                    ...
                    belowBarData: BarAreaData(
                      ...
                      gradient: LinearGradient(
                        colors: [
                          ...
                          dt.accent.withValues(alpha: 0.0),
                        ],
