...
abstract class AppLocalizations {
  ...
  /// No description provided for @checkInPatient.
  ///
  /// In en, this message translates to:
  /// **'Check In Patient'**
  String get checkInPatient;
  ...
  /// No description provided for @manualReportTabLabel.
  ///
  /// In en, this message translates to:
  /// **'Manual Report'**
  String get manualReportTabLabel;

  /// No description provided for @doctorLinkFailedWarning.
  ///
  /// In en, this message translates to:
  /// **'Doctor account not linked. Your assistant account may have been created without a valid Doctor Email. Ask your clinic admin to re-create your account with the correct Doctor Email so all clinic data becomes visible.'**
  ...
  /// No description provided for @medicalImagesTab.
  ///
  /// In en, this message translates to:
  /// **'Imaging'**
  String get medicalImagesTab;

  /// No description provided for @noImagingHistoryYet.
  ///
  /// In en, this message translates to:
  /// **'No imaging records'**
  String get noImagingHistoryYet;

  /// No description provided for @noImagingHistoryYetSub.
  ///
  /// In en, this message translates to:
  /// **'AI image analysis records appear here after consultations.'**
  ...
  /// No description provided for @errConflictRecord.
  ///
  /// In en, this message translates to:
  /// **'A record with this information already exists.'**
  String get errConflictRecord;

  /// No description provided for @errConflictAppointment.
  ///
  /// In en, this message translates to:
  /// **'This time slot is already booked. Please choose a different time.'**
  ...
  /// No description provided for @errFileUploadFailed.
  ///
  /// In en, this message translates to:
  /// **'File upload failed. Please check the file and try again.'**
  String get errFileUploadFailed;

  /// No description provided for @errInvalidPhoneNumber.
  ///
  /// In en, this message translates to:
  /// **'Please enter a valid phone number (at least 10 digits).'**
  String get errInvalidPhoneNumber;

  /// No description provided for @errInvalidFeeAmount.
  ///
  /// In en, this message translates to:
  /// **'Please enter a valid fee amount.'**
  String get errInvalidFeeAmount;

  /// No description provided for @errFutureDateRequired.
  ///
  /// In en, this message translates to:
  /// **'Please select a future date and time for the appointment.'**
  String get errFutureDateRequired;

  /// No description provided for @errConsultationIncomplete.
  ///
  /// In en, this message translates to:
  /// **'Please complete all required steps before finishing the consultation.'**
  String get errConsultationIncomplete;

  /// No description provided for @errReportFinalized.
  ///
  /// In en, this message translates to:
  /// **'This report has been finalized and cannot be modified.'**
  String get errReportFinalized;

  /// No description provided for @errUnchangedData.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @confirmCancelApptTitle.
  ///
  /// In en, this message translates to:
  /// **'Cancel Appointment'**
  String get confirmCancelApptTitle;

  /// No description provided for @confirmCancelApptBody.
  ///
  /// In en, this message translates to:
  /// **'Are you sure you want to cancel this appointment? The patient will need to rebook.'**
  String get confirmCancelApptBody;

  /// No description provided for @confirmCompleteConsultationTitle.
  ///
  /// In en, this message translates to:
  /// **'Complete Consultation'**
  String get confirmCompleteConsultationTitle;

  /// No description provided for @confirmCompleteConsultationBody.
  ///
  /// In en, this message translates to:
  /// **'The medical report will be finalized and sent to the patient. This cannot be undone.'**
  String get confirmCompleteConsultationBody;

  /// No description provided for @confirmMarkNoShowTitle.
  ///
  /// In en, this message translates to:
  /// **'Mark as No-Show'**
  String get confirmMarkNoShowTitle;

  /// No description provided for @confirmMarkNoShowBody.
  ///
  /// In en, this message translates to:
  /// **'Mark this patient as a no-show? This will update the appointment status.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Delete patient \"{name}\"? All associated records will also be removed. This cannot be undone.'**
  ...
  /// No description provided for @patientHistoryTabLabel.
  ///
  /// In en, this message translates to:
  /// **'History'**
  String get patientHistoryTabLabel;

  /// No description provided for @phLoadingHistory.
  ///
  /// In en, this message translates to:
  /// **'Loading patient history…'**
  String get phLoadingHistory;

  /// No description provided for @phErrorLoading.
  ///
  /// In en, this message translates to:
  /// **'Failed to load patient history'**
  String get phErrorLoading;

  /// No description provided for @phMedicalRecord.
  ///
  /// In en, this message translates to:
  /// **'Medical Record'**
  String get phMedicalRecord;

  /// No description provided for @phMedicalReport.
  ///
  /// In en, this message translates to:
  /// **'Medical Report'**
  String get phMedicalReport;

  /// No description provided for @phPreviousVisits.
  ///
  /// In en, this message translates to:
  /// **'Previous Visits'**
  String get phPreviousVisits;

  /// No description provided for @phChronicDiseases.
  ///
  /// In en, this message translates to:
  /// **'Chronic Diseases'**
  String get phChronicDiseases;

  /// No description provided for @phPreviousMedications.
  ///
  /// In en, this message translates to:
  /// **'Previous Medications'**
  String get phPreviousMedications;

  /// No description provided for @phLabReportsHistory.
  ///
  /// In en, this message translates to:
  /// **'Laboratory Reports'**
  String get phLabReportsHistory;

  /// No description provided for @phVisitDateLabel.
  ///
  /// In en, this message translates to:
  /// **'Visit date'**
  String get phVisitDateLabel;

  /// No description provided for @phMedicalImages.
  ///
  /// In en, this message translates to:
  /// **'Medical Images'**
  String get phMedicalImages;

  /// No description provided for @phAiMedicalReports.
  ///
  /// In en, this message translates to:
  /// **'Medical Reports'**
  String get phAiMedicalReports;

  /// No description provided for @phAllergiesAlerts.
  ///
  /// In en, this message translates to:
  /// **'Allergies & Alerts'**
  String get phAllergiesAlerts;

  /// No description provided for @phNoVisitsYet.
  ///
  /// In en, this message translates to:
  /// **'No previous visits'**
  String get phNoVisitsYet;

  /// No description provided for @phNoVisitsYetSub.
  ///
  /// In en, this message translates to:
  /// **'Completed visits will appear here.'**
  String get phNoVisitsYetSub;

  /// No description provided for @phNoDiseases.
  ///
  /// In en, this message translates to:
  /// **'No chronic diseases on record'**
  String get phNoDiseases;

  /// No description provided for @phNoDiseasesSub.
  ///
  /// In en, this message translates to:
  /// **'Conditions assigned to this patient will appear here.'**
  String get phNoDiseasesSub;

  /// No description provided for @phNoMedications.
  ///
  /// In en, this message translates to:
  /// **'No previous medications'**
  String get phNoMedications;

  /// No description provided for @phNoMedicationsSub.
  ///
  /// In en, this message translates to:
  /// **'Medications from prior consultation reports appear here.'**
  String get phNoMedicationsSub;

  /// No description provided for @phNoLabReports.
  ///
  /// In en, this message translates to:
  /// **'No laboratory reports'**
  String get phNoLabReports;

  /// No description provided for @phNoLabReportsSub.
  ///
  /// In en, this message translates to:
  /// **'Lab reports from all visits will appear here.'**
  String get phNoLabReportsSub;

  /// No description provided for @phLoadingLabs.
  ///
  /// In en, this message translates to:
  /// **'Loading lab reports…'**
  String get phLoadingLabs;

  /// No description provided for @phNoImages.
  ///
  /// In en, this message translates to:
  /// **'No medical images'**
  String get phNoImages;

  /// No description provided for @phNoImagesSub.
  ///
  /// In en, this message translates to:
  /// **'AI-analyzed images will appear here.'**
  String get phNoImagesSub;

  /// No description provided for @phNoReports.
  ///
  /// In en, this message translates to:
  /// **'No medical reports'**
  String get phNoReports;

  /// No description provided for @phNoReportsSub.
  ///
  /// In en, this message translates to:
  /// **'Voice and manual consultation reports appear here.'**
  String get phNoReportsSub;

  /// No description provided for @phAllergiesNotAvailable.
  ///
  /// In en, this message translates to:
  /// **'Allergy tracking not available'**
  String get phAllergiesNotAvailable;

  /// No description provided for @phAllergiesNotAvailableSub.
  ///
  /// In en, this message translates to:
  /// **'This feature requires a future backend update. Please check the patient\'s intake form for allergy and drug sensitivity information.'**
  String get phAllergiesNotAvailableSub;

  /// No description provided for @phViewReport.
  ///
  /// In en, this message translates to:
  /// **'View Report'**
  String get phViewReport;

  /// No description provided for @phViewImage.
  ///
  /// In en, this message translates to:
  /// **'View Image'**
  String get phViewImage;

  /// No description provided for @phDosage.
  ///
  /// In en, this message translates to:
  /// **'Dosage'**
  String get phDosage;

  /// No description provided for @phFrequency.
  ///
  /// In en, this message translates to:
  /// **'Frequency'**
  String get phFrequency;

  /// No description provided for @phDuration.
  ///
  /// In en, this message translates to:
  /// **'Duration'**
  String get phDuration;

  /// No description provided for @phPrescribedOn.
  ///
  /// In en, this message translates to:
  /// **'Prescribed'**
  String get phPrescribedOn;

  /// No description provided for @phActive.
  ///
  /// In en, this message translates to:
  /// **'Active'**
  String get phActive;

  /// No description provided for @phChiefComplaint.
  ///
  /// In en, this message translates to:
  /// **'Chief Complaint'**
  String get phChiefComplaint;

  /// No description provided for @phDoctorLabel.
  ///
  /// In en, this message translates to:
  /// **'Doctor'**
  String get phDoctorLabel;
  ...
  /// No description provided for @uploadedByLabel.
  ///
  /// In en, this message translates to:
  /// **'Uploaded by'**
  ...
  /// No description provided for @noLabRecordsAvailable.
  ///
  /// In en, this message translates to:
  /// **'No laboratory records available.'**
  String get noLabRecordsAvailable;

  /// No description provided for @noLabRecordsAvailableSub.
  ///
  /// In en, this message translates to:
  /// **'Laboratory files uploaded for this patient will appear here.'**
  ...
  /// In en, this message translates to:
  /// **'Laboratory History'**
  String get labHistoryTitle;

  /// No description provided for @labRecordsCount.
  ///
  /// In en, this message translates to:
  /// **'{count} {count, plural, =1{record} other{records}}'**
