...
class AdminDashboard extends ConsumerWidget {
    ...
    return Column(
      children: [
        SizedBox(
          ...
          child: Row(
            children: [
              Expanded(child: _buildStatCard(doctors)),
              const SizedBox(width: 12),
              Expanded(child: _buildStatCard(assistants)),
            ],
          ),
        ),
        ...
        SizedBox(
          ...
          child: Row(
            children: [
              Expanded(child: _buildStatCard(activeUsers)),
              const SizedBox(width: 12),
  ...
  Widget _buildUserDistribution(BuildContext context, AdminThemeData at, AdminStats stats) {
    ...
    final totalStaff = stats.totalDoctors + stats.totalAssistants;
